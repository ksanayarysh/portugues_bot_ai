...
class LessonGenerator:
    ...
    def _build_prompt(
        ...
        topic_descriptions = {
            ...
            "future_subjunctive": "Futuro do Subjuntivo и когда он реально используется",
            "personal_infinitive": "Личный инфинитив (Infinitivo Pessoal) — почему он вообще существует",
            "colocacao_pronominal": "Mesóclise, próclise, ênclise — куда прятать местоимения",
            "crase": "Crase (à) — когда ставить и когда не позориться",
            "reflexive_verbs": "Возвратные глаголы и их скрытые значения",
            "passive_voice": "Пассивный залог с 'ser' и с частицей 'se'",
            "impersonal_se": "Безличные конструкции с 'se'",
            "relative_pronouns": "Относительные местоимения (que, quem, cujo, onde)",
            "cujo_usage": "Использование CUJO без боли и страданий",
            "onde_vs_aonde": "Разница между ONDE и AONDE",
            "mal_vs_mau": "MAL vs MAU — два слова, которые путают всех",
            "bem_vs_bom": "BEM vs BOM — прилагательное против наречия",
            "por_que_variations": "POR QUE / POR QUÊ / PORQUÊ / PORQUE",
            "tem_vs_tem": "TEM vs TÊM — единственное и множественное",
            "haver_vs_ter": "HAVER vs TER в значении 'есть/имеется'",
            "time_expressions": "Выражения времени (há, faz, desde)",
            "perguntas_indiretas": "Косвенные вопросы",
            "double_negatives": "Двойное отрицание в португальском",
            "agreement_numbers": "Согласование числительных",
            "gender_nouns": "Род существительных и исключения",
            "augmentatives": "Увеличительные суффиксы -ão/-ona и оттенки смысла",
            "interjections": "Междометия и эмоциональные маркеры",
            "regional_accents": "Региональные акценты Бразилии",
            "vose_vs_voce": "История VOSSA MERCÊ → VOCÊ",
            "formal_email": "Как писать формальные письма в Бразилии",
            "whatsapp_language": "Язык WhatsApp и сокращения",
            "intonation_patterns": "Интонация в вопросах и утверждениях",
            "politeness_strategies": "Как вежливо отказывать по-бразильски",
            "business_portuguese": "Деловой португальский",
            "cultural_pragmatics": "Культурные нюансы общения в Бразилии",
            "future_subjunctive_vs_personal_infinitive": "Когда Futuro do Subjuntivo, а когда Infinitivo Pessoal в похожих конструкциях",
            "subjuntivo_after_talvez": "Talvez + Indicativo или Subjuntivo — и почему оба встречаются",
            "embora_mood": "Embora + Subjuntivo или Indicativo в реальной речи",
            "se_clauses_variations": "Все варианты SE: условие, безличное, возвратность",
            "quando_future": "Quando в будущем — почему нужен Subjuntivo",
            "assim_que": "Assim que + Subjuntivo или Indicativo",
            "logo_que_vs_depois_que": "Разница между Logo que и Depois que",
            "desde_que_conditions": "Desde que в значении условия",
            "antes_de_vs_antes_que": "Antes de + инфинитив vs Antes que + Subjuntivo",
            "apesar_de_vs_embora": "Apesar de + инфинитив vs Embora + Subjuntivo",
            "quanto_mais_structure": "Чем больше…, тем… (Quanto mais…, mais…)",
            "double_object_pronouns": "Два местоимения подряд (me o, lho, mo)",
            "mesoclise_usage": "Mesóclise в формальном будущем времени",
            "negative_imperative": "Почему отрицательный императив выглядит как Subjuntivo",
            "inflected_gerund": "Согласование в герундии (редко, но встречается)",
            "ter_participio_vs_ser_participio": "Ter + Particípio vs Ser + Particípio",
            "ficar_participio": "Ficar + Particípio и его оттенки",
            "andar_gerundio": "Andar + Gerúndio — длительное раздражение",
            "vir_a_infinitive": "Vir a + Infinitivo — скрытая будущность",
            "acabar_de": "Acabar de + Infinitivo — недавнее прошлое",
            "por_acaso_vs_acaso": "Por acaso vs Acaso — тонкая разница",
            "nem_sequer": "Nem sequer — усиленное отрицание",
            "que_expletivo": "Пустое 'que' в разговорной речи",
            "eis_que": "Eis que — литературная неожиданность",
            "cuja_concordancia": "Согласование после CUJO без ошибок"
        }
